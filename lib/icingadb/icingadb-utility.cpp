...
ArrayData IcingaDB::GetObjectIdentifiersPerEnv(const ConfigObject::Ptr& object)
{
...
{
	return HashValue(new Array(Prepend(GetEnvironment(), GetObjectIdentifiersPerEnv(object))));
}
